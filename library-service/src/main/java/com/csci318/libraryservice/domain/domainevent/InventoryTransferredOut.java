...
public record InventoryTransferredOut(String transferId, LibraryId sourceLibraryId, LibraryId targetLibraryId, Isbn isbn, int quantity, LocalDateTime occurredAt) {
}
